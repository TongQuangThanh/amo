(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-survey-survey-module"], {
    ...
    /***/
    function R3Ks(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _popup_survey_detail_popup_survey_detail_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../popup-survey-detail/popup-survey-detail.page */
      "EKRP");
      /* harmony import */
      ...
      function SurveyPage_div_15_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SurveyPage_div_15_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 19);
      ...
      function SurveyPage_div_15_div_6_ion_list_1_ion_item_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SurveyPage_div_15_div_6_ion_list_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionChange", function SurveyPage_div_15_div_6_ion_list_1_Template_ion_radio_group_ionChange_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r15);

            var question_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).$implicit;

            return question_r2.answer = $event.detail.value;
          });
      ...
      function SurveyPage_div_15_div_6_ion_list_2_ion_item_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function SurveyPage_div_15_div_6_ion_list_2_ion_item_1_Template_ion_checkbox_ngModelChange_3_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r20);

            var answer_r18 = ctx.$implicit;
            return answer_r18.isChecked = $event;
          });
      ...
      function SurveyPage_div_15_div_6_ion_list_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-list", 24);
      ...
      function SurveyPage_div_15_div_6_ion_textarea_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function SurveyPage_div_15_div_6_ion_textarea_3_Template_ion_textarea_ngModelChange_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r24);

            var question_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).$implicit;

            return question_r2.answer = $event;
          });
      ...
      function SurveyPage_div_15_div_6_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var question_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function SurveyPage_div_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SurveyPage_ion_button_17_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SurveyPage_ion_button_17_Template_ion_button_click_0_listener() {
            ...
            return ctx_r27.changeStep("prev");
          });
      ...
      var SurveyPage = /*#__PURE__*/function () {
        function SurveyPage(router, translate, alertController, apiService, modalController, loading, route) {
        ...
        _createClass(SurveyPage, [{
          ...
          key: "getSurveyDetail",
          value: function getSurveyDetail() {
            var _this = this;

            this.loading.present();
            this.apiService.getArticleDetail(this.surveyId).subscribe(function (result) {
              _this.surveyData = result.article;
              _this.survey = JSON.parse(_this.surveyData.survey);

              _this.mappingSurveyData();
          ...
          key: "changeStep",
          value: function changeStep(action) {
            var _this2 = this;

            if (action === 'next') {
              if (this.currentStep < this.survey.length - 1) {
                var surveyStep = this.survey[this.currentStep];

                if (surveyStep && surveyStep.question_type == '1' && !surveyStep.answer_option.find(function (opt) {
                ...
                this.apiService.postSurvey(this.surveyData._id, this.surveyResult).subscribe(function (res) {
                  _this2.router.navigate(['/survey-post-complete']);
                }, function (error) {});
              }
            } else {
              this.currentStep--;
          ...
          key: "mappingSurveyData",
          value: function mappingSurveyData() {
            this.survey = this.survey.map(function (item) {
              ...
              if (item.question_type == '1') {
                item.answer_option = item.answer_option.map(function (option) {
                  return {
                    value: option,
                    isChecked: false
                  };
          ...
          key: "createSurveyResult",
          value: function createSurveyResult() {
            var _this3 = this;

            this.survey.forEach(function (item, index) {
              if (item.question_type == '0') {
                _this3.surveyResult["".concat(index)] = {
                  content: item.question,
                  answer: item.answer
                };
              } else if (item.question_type == '1') {
                var answerResult = item.answer_option.filter(function (option) {
          ...
          key: "surveyDetailClick",
          value: function surveyDetailClick() {
      ...
      SurveyPage.ɵfac = function SurveyPage_Factory(t) {
        return new (t || SurveyPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]));
      };

      SurveyPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SurveyPage,
        selectors: [["app-survey"]],
        decls: 20,
        vars: 10,
        consts: [["slot", "fixed", 1, "no-scroll", "survey-wrapper"], [1, "survey-header"], [1, "back-button"], ["color", "light", "text", "", "icon", "chevron-back", 1, "ion-back-button"], [1, "header-title"], [1, "survey-title-wrapper"], [1, "survey-title"], [1, "survey-sub-title"], [1, "survey-detail-link", 3, "click"], [1, "survey-content"], [3, "class", 4, "ngFor", "ngForOf"], [1, "navigation-block", 3, "ngClass"], ["color", "light", "shape", "round", "class", "navigation-btn", 3, "click", 4, "ngIf"], ["color", "light", "shape", "round", 1, "navigation-btn", 3, "click"], ["name", "arrow-forward-outline"], ["class", "question-order", 4, "ngIf"], [1, "question"], [1, "question-title"], ["class", "answer-block", 4, "ngIf"], [1, "question-order"], ["name", "checkmark"], [1, "answer-block"], ["class", "list-anwers", 4, "ngIf"], ["class", "answer-textarea", "placeholder", "Vi\u1EBFt \xFD ki\u1EBFn", "autoGrow", "true", 3, "ngModel", "ngModelChange", 4, "ngIf"], [1, "list-anwers"], ["value", "biff", 3, "value", "ionChange"], ["class", "answer-item", "lines", "none", 4, "ngFor", "ngForOf"], ["lines", "none", 1, "answer-item"], [1, "answer-label"], ["mode", "md", "slot", "start", "color", "light", 3, "value"], ["mode", "md", "slot", "start", "color", "light", 1, "survey-checkbox", 3, "ngModel", "ngModelChange"], ["placeholder", "Vi\u1EBFt \xFD ki\u1EBFn", "autoGrow", "true", 1, "answer-textarea", 3, "ngModel", "ngModelChange"], ["name", "arrow-back-outline"]],
        template: function SurveyPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SurveyPage_Template_ion_label_click_11_listener() {
              return ctx.surveyDetailClick();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SurveyPage_Template_ion_button_click_18_listener() {
              return ctx.changeStep("next");
            });
    ...
    /***/
    function jCSH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _survey_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./survey.page */
      "R3Ks");
      ...
      SurveyPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: SurveyPageModule
      });
      SurveyPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function SurveyPageModule_Factory(t) {
          return new (t || SurveyPageModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_6__["MatTabsModule"], _ionic_super_tabs_angular__WEBPACK_IMPORTED_MODULE_7__["SuperTabsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SurveyPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SurveyPageModule, [{
