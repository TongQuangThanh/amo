(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-news-news-module"], {
    ...
    function Bp3h(module, __webpack_exports__, __webpack_require__) {
      ...
      function NewsPage_ion_card_9_Template(rf, ctx) {
        if (rf & 1) {
          var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-card", 8);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewsPage_ion_card_9_Template_ion_card_click_0_listener($event) {
      ...
      var NewsPage = /*#__PURE__*/function () {
        function NewsPage(loading, apiService, navCtrl, nativePageTransitions) {
        ...
        _createClass(NewsPage, [{
          ...
          key: "getListPosts",
          value: function getListPosts(page, limit, category, search, event, isRefresh) {
            var self = this;
            ...
            this.getPostSubscriber = this.apiService.getPosts(page, limit, category, search).subscribe(function (result) {
              if (isRefresh) {
      ...
      NewsPage.ɵfac = function NewsPage_Factory(t) {
        return new (t || NewsPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_native_native_page_transitions_ngx__WEBPACK_IMPORTED_MODULE_3__["NativePageTransitions"]));
      };

      NewsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: NewsPage,
        selectors: [["app-news"]],
        decls: 12,
        vars: 4,
        consts: [[1, "ion-no-border"], [1, "header-toolbar"], [1, "title-info"], ["slot", "fixed", 3, "ionRefresh"], ["pullingIcon", "circles", "refreshingSpinner", "", "refreshingText", ""], ["class", "info-card", "button", "", 3, "id", "click", 4, "ngFor", "ngForOf"], ["threshold", "100px", 3, "ionInfinite"], ["loadingSpinner", "", "loadingText", ""], ["button", "", 1, "info-card", 3, "id", "click"], [1, "card-img"], [3, "src"], [1, "badge-corner", "badge-corner-base"], ["lines", "none"], [1, "ion-text-wrap", "content-two-line", "content-title"], [1, "ion-float-left"], ["lines", "none", 1, "card-bottom"], ["item-start", "", "name", "eye-outline", 1, "card-bottom-icon"], [1, "card-bottom-label"], ["item-start", "", "name", "custom-comment", "src", "assets/icon/custom-comment.svg", 1, "card-bottom-icon"], ["item-start", "", "name", "custom-attach", "src", "assets/icon/custom-attach.svg", 1, "card-bottom-icon"]],
        template: function NewsPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionRefresh", function NewsPage_Template_ion_refresher_ionRefresh_6_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionInfinite", function NewsPage_Template_ion_infinite_scroll_ionInfinite_10_listener($event) {
    ...
    function XkMT(module, __webpack_exports__, __webpack_require__) {
      ...
      NewsPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NewsPageRoutingModule
      });
      NewsPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function NewsPageRoutingModule_Factory(t) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewsPageRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewsPageRoutingModule, [{
