(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-call-the-car-detail-call-the-car-detail-module"], {
    ...
    /***/
    function BDh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CallTheCarDetailPage", function () {
        return CallTheCarDetailPage;
      });
      /* harmony import */
      ...
      function CallTheCarDetailPage_label_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var CallTheCarDetailPage = /*#__PURE__*/function () {
        function CallTheCarDetailPage(translate, loading, apiService, navCtrl, alertService, platform, route) {
          _classCallCheck(this, CallTheCarDetailPage);
          ...
          this.route = route;
          var id_service = this.route.snapshot.paramMap.get('id');
          this.id_service = id_service;
        }

        _createClass(CallTheCarDetailPage, [{
          key: "ngOnInit",
      ...
      CallTheCarDetailPage.ɵfac = function CallTheCarDetailPage_Factory(t) {
        return new (t || CallTheCarDetailPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_alert_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]));
      };

      CallTheCarDetailPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: CallTheCarDetailPage,
        selectors: [["app-call-the-car-detail"]],
        decls: 16,
        vars: 12,
        consts: [[1, "ion-no-border"], ["slot", "start"], ["text", ""], ["lines", "full", 1, "ion-no-margin", "ion-no-padding", "margin-top-10"], ["lines", "none", 1, "margin-top-20"], ["lines", "none", 1, "item-common"], ["src", "../assets/icon/Compass.png", 1, "icon-text-box-active"], ["class", "text-box-placeholder", 4, "ngIf"], ["type", "text", "type", "text", 1, "text-box-1", 3, "placeholder", "value", "ngModel", "ionChange", "ngModelChange"], [1, "text-box-placeholder"]],
        template: function CallTheCarDetailPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionChange", function CallTheCarDetailPage_Template_ion_input_ionChange_14_listener() {
              return ctx.ionChangeTextBox1();
            })("ngModelChange", function CallTheCarDetailPage_Template_ion_input_ngModelChange_14_listener($event) {
              return ctx.place_from = $event;
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CallTheCarDetailPage, [{
    ...
    /***/
    function M3TY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CallTheCarDetailPageModule", function () {
        return CallTheCarDetailPageModule;
      });
      /* harmony import */
      ...
      var _call_the_car_detail_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./call-the-car-detail.page */
      "8BDh");
      /* harmony import */
      ...
      var CallTheCarDetailPageModule = function CallTheCarDetailPageModule() {
        _classCallCheck(this, CallTheCarDetailPageModule);
      };

      CallTheCarDetailPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: CallTheCarDetailPageModule
      });
      CallTheCarDetailPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function CallTheCarDetailPageModule_Factory(t) {
          return new (t || CallTheCarDetailPageModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CallTheCarDetailPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CallTheCarDetailPageModule, [{
...
//# sourceMappingURL=pages-call-the-car-detail-call-the-car-detail-module-es5.js.map