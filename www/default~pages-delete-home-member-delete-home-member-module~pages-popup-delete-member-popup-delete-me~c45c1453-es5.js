(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-delete-home-member-delete-home-member-module~pages-popup-delete-member-popup-delete-me~c45c1453"], {
    ...
    /***/
    function Z7ln(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupDeleteMemberPage", function () {
        return PopupDeleteMemberPage;
      });
      /* harmony import */
      ...
      var PopupDeleteMemberPage = /*#__PURE__*/function () {
        function PopupDeleteMemberPage(apiService, loading, modalController, navParams) {
          _classCallCheck(this, PopupDeleteMemberPage);
        ...
        _createClass(PopupDeleteMemberPage, [{
          key: "ngOnInit",
          ...
          value: function deleteMember() {
            ...
            this.apiService.deleteApartmentMember(params).subscribe(function (result) {
      ...
      PopupDeleteMemberPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function PopupDeleteMemberPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PopupDeleteMemberPage_Template_ion_buttons_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PopupDeleteMemberPage_Template_ion_button_click_12_listener() {
              return ctx.deleteMember();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PopupDeleteMemberPage_Template_ion_button_click_16_listener() {
              return ctx.closeModal();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PopupDeleteMemberPage, [{
...
//# sourceMappingURL=default~pages-delete-home-member-delete-home-member-module~pages-popup-delete-member-popup-delete-me~c45c1453-es5.js.map