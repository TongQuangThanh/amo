(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-payment-confirm-payment-confirm-module"], {
    ...
    function Mjr(module, __webpack_exports__, __webpack_require__) {
      ...
      var _popup_payment_function_popup_payment_function_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../popup-payment-function/popup-payment-function.page */
      "u6YQ");
      /* harmony import */


      var _popup_payment_success_popup_payment_success_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../popup-payment-success/popup-payment-success.page */
      "8Q1X");
      /* harmony import */


      var _popup_iframe_payment_popup_iframe_payment_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../popup-iframe-payment/popup-iframe-payment.page */
      "zzVl");
      /* harmony import */
      ...
      function PaymentConfirmPage_ion_list_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PaymentConfirmPage_ion_button_68_Template(rf, ctx) {
        if (rf & 1) {
          var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-button", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PaymentConfirmPage_ion_button_68_Template_ion_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r5);

            var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r4.openPayment();
          });
      ...
      var PaymentConfirmPage = /*#__PURE__*/function () {
        function PaymentConfirmPage(modalController, loading, apiService, navCtrl, route, translate, alertController, iab) {
        ...
        _createClass(PaymentConfirmPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.paymentType = 'payment_cash';
            this.getPaymentDetail(this.paymentID); // this.dumyPaymentMethod();
          }
        }, {
          ...
          key: "changePaymentModal",
          value: function changePaymentModal(paymentType) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var self, modalChangePayemt;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      modalChangePayemt = _context.sent;
                      modalChangePayemt.onDidDismiss().then(function (result) {
                      ...
                      _context.next = 7;
                      return modalChangePayemt.present();
          ...
          key: "paymentSuccessShow",
          value: function paymentSuccessShow() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var self, popupPaymentSuccessPage;
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      popupPaymentSuccessPage = _context2.sent;
                      _context2.next = 6;
                      return popupPaymentSuccessPage.present();
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      modalPay = _context3.sent;
                      modalPay.onDidDismiss().then(function (result) {
          ...
          key: "payTheBillOnlineOrCash",
          value: function payTheBillOnlineOrCash(paymentSelected) {
            this.loading.present();
            var self = this;
            var params = {
              bill: this.paymentID,
            ...
            this.apiService.postPayTheBill(params).subscribe(function (result) {
              self.loading.dismiss();
              self.paymentSuccessShow(); // self.navCtrl.navigateForward('/popup-payment-success');
            }, function (error) {
              self.loading.dismiss(); // self.navCtrl.navigateForward('/payment-fail');
            });
          }
        }, {
          key: "openPayment",
          value: function openPayment() {
            ...
            var self = this; // this.apiService.epaypayment(this.totalCash).subscribe((result) => {
            //   console.log(result);
            ...
            if (this.paymentType == 'payment_cash') {
              ...
              this.loading.present();
              this.apiService.momoPayment(this.totalCash - this.promotionMoney - this.paidAmount).subscribe(function (result) {
                self.loading.dismiss();
          ...
          key: "openURLAccuracyEpay",
          value: function openURLAccuracyEpay(url) {
            var browser = this.iab.create(url, '_system', 'location=yes, enableviewportscale=yes');
            browser.show();
          } // dumyPaymentMethod() {
          //   this.paymentMethodList = [];
          //   this.epayUserInfo = this.apiService.getEpayUserStored();
      ...
      PaymentConfirmPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function PaymentConfirmPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function PaymentConfirmPage_Template_ion_radio_group_ngModelChange_51_listener($event) {
    ...
    /***/
    function mZDy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _payment_confirm_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      PaymentConfirmPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: PaymentConfirmPageModule
      });
      PaymentConfirmPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function PaymentConfirmPageModule_Factory(t) {
          return new (t || PaymentConfirmPageModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PaymentConfirmPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PaymentConfirmPageModule, [{
...
//# sourceMappingURL=pages-payment-confirm-payment-confirm-module-es5.js.map