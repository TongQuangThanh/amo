(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-new-detail-new-detail-module~pages-notification-detail-notification-detail-module~page~2c467832"], {
    ...
    /***/
    function Et2Y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupShareInfoPage", function () {
        return PopupShareInfoPage;
      });
      /* harmony import */
      ...
      var src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var src_app_utils_const_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      function PopupShareInfoPage_div_15_ion_img_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PopupShareInfoPage_div_15_ion_img_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ion-img", 35);
        }
      }

      function PopupShareInfoPage_div_15_div_18_ion_img_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ion-img", 34);
        }

        if (rf & 2) {
          var reply_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", reply_r9.createdBy.avatar);
        }
      }

      function PopupShareInfoPage_div_15_div_18_ion_img_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ion-img", 35);
        }
      }

      function PopupShareInfoPage_div_15_div_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PopupShareInfoPage_div_15_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupShareInfoPage_div_15_Template_ion_label_click_15_listener() {
            ...
            return ctx_r13.replyComment(item_r4._id, item_r4 == null ? null : item_r4.createdBy == null ? null : item_r4.createdBy.displayName);
          });
      ...
      function PopupShareInfoPage_ion_item_19_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupShareInfoPage_ion_item_19_Template_ion_label_click_6_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);

            var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r15.cancelReplyComment();
          });
      ...
      var PopupShareInfoPage = /*#__PURE__*/function () {
        function PopupShareInfoPage(translateConfigService, modalController, navParams, clipboard, translate, alertService, apiService, loading, route) {
          _classCallCheck(this, PopupShareInfoPage);
        ...
        _createClass(PopupShareInfoPage, [{
          key: "ngOnInit",
          ...
          value: function sendMsg() {
            ...
            if (this.isPostType) {
              if (this.replyId !== null) {
                // send reply comment
                this.apiService.sendPostReply(params, this.replyId).subscribe(function (res) {
                  self.loading.dismiss();
                  self.editorMsg = ''; // self.doRefresh(null);
                }, function (err) {
                  self.editorMsg = '';
                  self.loading.dismiss();
                });
              } else {
                this.apiService.sendPostComment(params, this.articleID).subscribe(function (result) {
                  self.loading.dismiss();
                  self.editorMsg = ''; // self.doRefresh(null);
                }, function (error) {
                  self.editorMsg = '';
              ...
              if (this.replyId !== null) {
                // send reply comment
                this.apiService.sendArticleReply(params, this.replyId).subscribe(function (res) {
                  var commentReply = res.commentReply;
                  commentReply.createdBy = self.profileUser;
                  var comment = self.listArticlesComment.find(function (item) {
                    return item._id == commentReply.comment;
                  });

                  if (comment) {
                    comment.replies.unshift(commentReply);
                    self.listArticlesComment = _toConsumableArray(self.listArticlesComment);
                  }
                ...
                this.apiService.sendArticleComment(params, this.articleID).subscribe(function (result) {
                  ...
                  self.listArticlesComment = [comment].concat(_toConsumableArray(_this.listArticlesComment));
                  self.commentsCount++;
                  self.loading.dismiss();
                  self.editorMsg = '';
                  setTimeout(function () {
          ...
          key: "replyComment",
          value: function replyComment(id, name) {
            this.replyId = id;
            this.replyName = name;
            document.getElementById('reply-item').focus();
          }
        }, {
          key: "cancelReplyComment",
          value: function cancelReplyComment() {
            this.replyId = null;
            this.replyName = null;
          }
        }, {
          ...
          value: function time_ago(time) {
            ...
            var time_formats = [[60, this.translate.instant('TIME_AGO.seconds'), 1], [120, this.translate.instant('TIME_AGO.a_minute'), this.translate.instant('TIME_AGO.a_minute_from')], [3600, this.translate.instant('TIME_AGO.minutes'), 60], [7200, this.translate.instant('TIME_AGO.a_hour_ago'), this.translate.instant('TIME_AGO.a_hour_from')], [86400, this.translate.instant('TIME_AGO.hours'), 3600], [172800, this.translate.instant('TIME_AGO.yesterday'), this.translate.instant('TIME_AGO.tomorrow')], [604800, this.translate.instant('TIME_AGO.days'), 86400], [1209600, this.translate.instant('TIME_AGO.last_week'), this.translate.instant('TIME_AGO.next_week')], [2419200, this.translate.instant('TIME_AGO.weeks'), 604800], [4838400, this.translate.instant('TIME_AGO.last_month'), this.translate.instant('TIME_AGO.next_month')], [29030400, this.translate.instant('TIME_AGO.months'), 2419200], [58060800, this.translate.instant('TIME_AGO.last_year'), this.translate.instant('TIME_AGO.next_year')], [2903040000, this.translate.instant('TIME_AGO.years'), 29030400], [5806080000, this.translate.instant('TIME_AGO.last_century'), this.translate.instant('TIME_AGO.next_century')], [58060800000, this.translate.instant('TIME_AGO.centuries'), 2903040000]];
            var seconds = (+new Date() - time) / 1000;
            var token = this.translate.instant('TIME_AGO.ago');
            var list_choice = 1;
          ...
          value: function postLike() {
            ...
            if (this.isPostType) {
              this.apiService.postPostLike(this.articleID, likeStatus).subscribe(function (response) {
      ...
      PopupShareInfoPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function PopupShareInfoPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupShareInfoPage_Template_ion_buttons_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupShareInfoPage_Template_ion_buttons_click_8_listener() {
              return ctx.postLike();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionInfinite", function PopupShareInfoPage_Template_ion_infinite_scroll_ionInfinite_16_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PopupShareInfoPage_Template_ion_textarea_ngModelChange_22_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupShareInfoPage_Template_img_click_26_listener() {
              return ctx.sendMsg();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupShareInfoPage, [{
          ...
          return [{
            ...
            type: src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"]
          }, {
            type: src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"]
          }, {
...
//# sourceMappingURL=default~pages-new-detail-new-detail-module~pages-notification-detail-notification-detail-module~page~2c467832-es5.js.map