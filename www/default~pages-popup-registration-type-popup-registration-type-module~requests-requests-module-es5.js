(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-popup-registration-type-popup-registration-type-module~requests-requests-module"], {
    ...
    /***/
    function Y4cL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupRegistrationTypePage", function () {
        return PopupRegistrationTypePage;
      });
      /* harmony import */
      ...
      var PopupRegistrationTypePage = /*#__PURE__*/function () {
        function PopupRegistrationTypePage(translateConfigService, modalController, navCtrl) {
          _classCallCheck(this, PopupRegistrationTypePage);
        ...
        _createClass(PopupRegistrationTypePage, [{
          key: "ngOnInit",
          ...
          key: "eventButton3",
          value: function eventButton3() {
            this.navCtrl.navigateForward('/register-to-receive-goods');
            this.closeModal();
          }
        }, {
          key: "eventButton4",
          value: function eventButton4() {
            this.navCtrl.navigateForward('/register-for-shipping');
            this.closeModal();
          }
        }, {
          key: "registKeepVehicle",
          value: function registKeepVehicle() {
      ...
      PopupRegistrationTypePage.ɵfac = function PopupRegistrationTypePage_Factory(t) {
        return new (t || PopupRegistrationTypePage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"]));
      };

      PopupRegistrationTypePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: PopupRegistrationTypePage,
        selectors: [["app-popup-registration-type"]],
        decls: 35,
        vars: 15,
        consts: [[1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item", "ion-no-padding"], [1, "popup-title"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], [1, "ion-align-items-center"], [1, "item-type", 3, "click"], ["name", "custom-car", "src", "assets/icon/custom-car.svg", 1, "item-icon"], [1, "item-label"], [1, ""], ["name", "custom-team", "src", "assets/icon/custom-team.svg", 1, "item-icon"], ["name", "custom-archive", "src", "assets/icon/custom-archive.svg", 1, "item-icon"], ["name", "custom-truck", "src", "assets/icon/custom-truck.svg", 1, "item-icon"]],
        template: function PopupRegistrationTypePage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupRegistrationTypePage_Template_ion_buttons_click_6_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupRegistrationTypePage_Template_ion_col_click_10_listener() {
              return ctx.registKeepVehicle();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupRegistrationTypePage_Template_ion_col_click_16_listener() {
              return ctx.registGuest();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupRegistrationTypePage_Template_ion_col_click_23_listener() {
              return ctx.eventButton3();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupRegistrationTypePage_Template_ion_col_click_29_listener() {
              return ctx.eventButton4();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupRegistrationTypePage, [{
...
//# sourceMappingURL=default~pages-popup-registration-type-popup-registration-type-module~requests-requests-module-es5.js.map