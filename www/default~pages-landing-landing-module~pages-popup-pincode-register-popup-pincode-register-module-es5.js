(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-landing-landing-module~pages-popup-pincode-register-popup-pincode-register-module"], {
    ...
    /***/
    function Z3Km(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupPincodeRegisterPage", function () {
        return PopupPincodeRegisterPage;
      });
      /* harmony import */
      ...
      function PopupPincodeRegisterPage_ion_col_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("keyup", function PopupPincodeRegisterPage_ion_col_14_Template_input_keyup_1_listener($event) {
          ...
          })("keydown", function PopupPincodeRegisterPage_ion_col_14_Template_input_keydown_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r8);
      ...
      function PopupPincodeRegisterPage_ion_label_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PopupPincodeRegisterPage_ion_spinner_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "ion-spinner", 23);
        }
      }

      function PopupPincodeRegisterPage_span_23_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var PopupPincodeRegisterPage = /*#__PURE__*/function () {
        function PopupPincodeRegisterPage(translateConfigService, modalController, apiService, loading, navParams) {
          _classCallCheck(this, PopupPincodeRegisterPage);
        ...
        _createClass(PopupPincodeRegisterPage, [{
          key: "ngOnInit",
          ...
          value: function initiateBuilder() {
            ...
            for (var i = 0; i < this.codeSize; i++) {
              var formController = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]({
                value: '',
                disabled: true
      ...
      PopupPincodeRegisterPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function PopupPincodeRegisterPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PopupPincodeRegisterPage_Template_ion_buttons_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PopupPincodeRegisterPage_Template_ion_button_click_27_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PopupPincodeRegisterPage, [{
...
//# sourceMappingURL=default~pages-landing-landing-module~pages-popup-pincode-register-popup-pincode-register-module-es5.js.map