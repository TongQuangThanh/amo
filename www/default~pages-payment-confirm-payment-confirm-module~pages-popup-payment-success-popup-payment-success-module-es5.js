(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-payment-confirm-payment-confirm-module~pages-popup-payment-success-popup-payment-success-module"], {
    ...
    /***/
    function Q1X(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupPaymentSuccessPage", function () {
        return PopupPaymentSuccessPage;
      });
      /* harmony import */
      ...
      var PopupPaymentSuccessPage = /*#__PURE__*/function () {
        function PopupPaymentSuccessPage(translateConfigService, modalController, navCtrl) {
          _classCallCheck(this, PopupPaymentSuccessPage);
        ...
        _createClass(PopupPaymentSuccessPage, [{
          key: "ngOnInit",
      ...
      PopupPaymentSuccessPage.ɵfac = function PopupPaymentSuccessPage_Factory(t) {
        return new (t || PopupPaymentSuccessPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"]));
      };

      PopupPaymentSuccessPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: PopupPaymentSuccessPage,
        selectors: [["app-popup-payment-success"]],
        decls: 15,
        vars: 6,
        consts: [[1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], ["lines", "none", 1, "ion-text-center"], ["name", "checkmark-circle-outline", 1, "trash-icon"], [1, "ion-text-center", "modal-item"], [1, "normal-message"], [1, "ion-text-center", "modal-bottom", 3, "click"], [1, "extra-message"]],
        template: function PopupPaymentSuccessPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupPaymentSuccessPage_Template_ion_buttons_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupPaymentSuccessPage_Template_ion_toolbar_click_11_listener() {
              return ctx.listPayment();
            });
        ...
        directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonContent"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonItem"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonButtons"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonIcon"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonToolbar"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupPaymentSuccessPage, [{
...
//# sourceMappingURL=default~pages-payment-confirm-payment-confirm-module~pages-popup-payment-success-popup-payment-success-module-es5.js.map