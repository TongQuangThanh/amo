...
/* harmony import */ var _popup_share_info_popup_share_info_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../popup-share-info/popup-share-info.page */ "Et2Y");
...
function NewDetailPage_ion_img_12_Template(rf, ctx) { if (rf & 1) {
...
function NewDetailPage_ion_img_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "ion-img", 23);
} }
function NewDetailPage_section_34_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NewDetailPage_section_34_Template_ion_button_click_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r3.orderService($event); });
...
class NewDetailPage {
    constructor(platform, sanitizer, loading, apiService, navCtrl, route, modalController) {
    ...
    getNewDetail() {
        ...
        const self = this;
        this.apiService.getPosteDetail(this.newID).subscribe((result) => {
    ...
    addCountPostClick() {
        this.apiService.countUserButtonPost(this.newID).subscribe((result) => { }, (error) => { });
    }
    orderService(event) {
...
NewDetailPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: NewDetailPage, selectors: [["app-new-detail"]], decls: 35, vars: 19, consts: [["id", "main-header-toolbar", 1, "ion-no-border", 3, "ngStyle"], ["slot", "start", 1, "back-button"], ["id", "", "text", "", "icon", "chevron-back"], ["id", "sub-header-toolbar", 1, "ion-no-border", "w3-animate-top", 3, "ngStyle"], [1, "header-splash"], ["lines", "none", 2, "margin-top", "10px"], [1, "ion-text-wrap", "content-two-line"], ["slot", "start", 1, "btn-header-back"], ["fullscreen", "", 3, "scrollEvents", "ionScroll"], [3, "src", 4, "ngIf"], ["src", "assets/common/no-thumbnail.png", 4, "ngIf"], ["button", "", 1, "custom-card", "margin-none"], ["lines", "none", 1, "ion-item-title"], ["id", "content-news"], [1, "text-node", "information-node"], [1, "ion-float-left", "padding-none", "card-bottom"], [1, "card-bottom-label"], ["item-start", "", "name", "custom-oval", "src", "assets/icon/custom-oval.svg", 1, "card-bottom-icon", "custom-oval"], [1, "ion-float-left", "padding-none", "card-bottom", "margin-left-0"], [1, "line-break-content"], [1, "article-content", 2, "width", "100%", 3, "innerHTML"], ["class", "full-width function-section", 4, "ngIf"], [3, "src"], ["src", "assets/common/no-thumbnail.png"], [1, "full-width", "function-section"], ["expand", "block", 1, "button-common", "button-common-active", 3, "click"]], template: function NewDetailPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionScroll", function NewDetailPage_Template_ion_content_ionScroll_11_listener($event) { return ctx.onScroll($event); });
...
/* harmony import */ var _new_detail_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./new-detail.page */ "Qk/J");
...
class NewDetailPageModule {
}
NewDetailPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: NewDetailPageModule });
NewDetailPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function NewDetailPageModule_Factory(t) { return new (t || NewDetailPageModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewDetailPageModule, { declarations: [_new_detail_page__WEBPACK_IMPORTED_MODULE_5__["NewDetailPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewDetailPageModule, [{
...
//# sourceMappingURL=pages-new-detail-new-detail-module-es2015.js.map