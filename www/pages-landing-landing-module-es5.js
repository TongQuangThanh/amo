(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-landing-landing-module"], {
    ...
    function ARrX(module, __webpack_exports__, __webpack_require__) {
      ...
      var _popup_pincode_register_popup_pincode_register_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../popup-pincode-register/popup-pincode-register.page */
      "Z3Km");
      /* harmony import */
      ...
      var PHONE_LENGTH_VN = 10;

      var LandingPage = /*#__PURE__*/function () {
        function LandingPage(menu, loading, authService, navCtrl, translateConfigService, apiService, modalController) {
                      ...
                      modal.onDidDismiss().then(function (dataReturned) {
                        if (dataReturned !== null) {
                          ...
                          if (dataReturnedResult.result == '0') {
                            _this.navCtrl.navigateForward('/register-password/' + _this.phoneNumber + "/" + dataReturnedResult.token + "/" + dataReturnedResult.refCode);
                          } else {}
                        }
                      });
                      _context.next = 6;
      ...
      LandingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function LandingPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LandingPage_Template_ion_button_click_12_listener() {
              return ctx.ChangeLogin();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LandingPage_Template_ion_button_click_16_listener() {
              return ctx.SkipLogin();
            });
    ...
    function CXjK(module, __webpack_exports__, __webpack_require__) {
      ...
      var _landing_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./landing.page */
      "ARrX");
      /* harmony import */
      ...
      /*! @ngx-translate/core */
      "sYmb"); // import { LoginPage } from '../auth/login/login.page';
