...
/* harmony import */ var _utils_utils_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/utils.service */ "GUvF");
/* harmony import */ var _popup_share_info_popup_share_info_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../popup-share-info/popup-share-info.page */ "Et2Y");
...
function NotificationDetailPage_ion_img_12_Template(rf, ctx) { if (rf & 1) {
...
function NotificationDetailPage_ion_img_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "ion-img", 34);
} }
function NotificationDetailPage_div_33_ion_card_2_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-card", 38);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NotificationDetailPage_div_33_ion_card_2_Template_ion_card_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2); return ctx_r5.detailAttachment($event); });
...
function NotificationDetailPage_div_33_Template(rf, ctx) { if (rf & 1) {
...
class NotificationDetailPage {
    constructor(iab, loading, sanitizer, apiService, navCtrl, route, authService, modalController) {
        this.iab = iab;
    ...
    getArticleDetail(articleID) {
        ...
        this.apiService.getArticleDetail(articleID).subscribe((result) => {
            ...
            this.isLiked = (result === null || result === void 0 ? void 0 : result.userLike) == 1 ? true : false;
...
NotificationDetailPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: NotificationDetailPage, selectors: [["app-notification-detail"]], decls: 66, vars: 42, consts: [["id", "main-header-toolbar", 1, "ion-no-border", 3, "ngStyle"], ["slot", "start", 1, "back-button"], ["id", "", "text", "", "icon", "chevron-back"], ["id", "sub-header-toolbar", 1, "ion-no-border", "w3-animate-top", 3, "ngStyle"], [1, "header-splash"], ["lines", "none", 2, "margin-top", "10px"], [1, "ion-text-wrap", "content-two-line"], ["slot", "start", 1, "btn-header-back"], ["fullscreen", "", 3, "scrollEvents", "ionScroll"], [3, "src", 4, "ngIf"], ["src", "assets/common/no-thumbnail.png", 4, "ngIf"], ["button", "", 1, "custom-card", "margin-none"], ["lines", "none", 1, "ion-item-title"], ["id", "content-noti", 1, ""], [1, "text-node", "information-node"], [1, "ion-float-left", "padding-none", "card-bottom"], [1, "card-bottom-label"], ["item-start", "", "name", "custom-oval", "src", "assets/icon/custom-oval.svg", 1, "card-bottom-icon", "custom-oval"], [1, "ion-float-left", "padding-none", "card-bottom", "margin-left-0"], ["class", "clear-both attachments-div", 4, "ngIf"], [1, "line-break-content"], [1, "full-width", "article-content", 3, "innerHTML"], [1, "ion-no-border", "footer-content", "share-info"], [1, "footer-grid-col", 3, "click"], [1, "ion-col-img"], ["src", "/assets/icon/svg/news/like.svg", 1, "share-info-img"], [1, "ion-text-left"], [1, "share-info-title", 3, "ngClass"], [1, "ion-text-left", "landing-text"], [1, "share-info-text"], [1, "ion-col-break"], ["src", "/assets/icon/svg/news/comment.svg", 1, "share-info-img"], [1, "share-info-title"], [3, "src"], ["src", "assets/common/no-thumbnail.png"], [1, "clear-both", "attachments-div"], [1, "text-node", "attachments-node"], ["class", "ion-float-left padding-none attachments-card", 3, "id", "click", 4, "ngFor", "ngForOf"], [1, "ion-float-left", "padding-none", "attachments-card", 3, "id", "click"], [1, "attachments-text"], ["name", "custom-attach-active", "src", "assets/icon/custom-attach-active.svg", 1, "attachments-icon"]], template: function NotificationDetailPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionScroll", function NotificationDetailPage_Template_ion_content_ionScroll_11_listener($event) { return ctx.onScroll($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NotificationDetailPage_Template_ion_col_click_39_listener() { return ctx.postLike(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NotificationDetailPage_Template_ion_col_click_53_listener() { return ctx.commentNotificationModal(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NotificationDetailPage, [{
    ...
    }], function () { return [{ type: _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_3__["InAppBrowser"] }, { type: _services_loading_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["DomSanitizer"] }, { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: src_app_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"] }]; }, null); })();
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var _notification_detail_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./notification-detail.page */ "8dpY");
...
NotificationDetailPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: NotificationDetailPageModule });
NotificationDetailPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function NotificationDetailPageModule_Factory(t) { return new (t || NotificationDetailPageModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NotificationDetailPageModule, { declarations: [_notification_detail_page__WEBPACK_IMPORTED_MODULE_5__["NotificationDetailPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotificationDetailPageModule, [{
...
//# sourceMappingURL=pages-notification-detail-notification-detail-module-es2015.js.map