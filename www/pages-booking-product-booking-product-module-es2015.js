...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BookingProductPageModule", function() { return BookingProductPageModule; });
...
/* harmony import */ var _booking_product_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./booking-product.page */ "YVeV");
...
class BookingProductPageModule {
}
BookingProductPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: BookingProductPageModule });
BookingProductPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function BookingProductPageModule_Factory(t) { return new (t || BookingProductPageModule)(); }, providers: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["DatePipe"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BookingProductPageModule, { declarations: [_booking_product_page__WEBPACK_IMPORTED_MODULE_6__["BookingProductPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BookingProductPageModule, [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BookingProductPage", function() { return BookingProductPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
function BookingProductPage_ion_item_9_div_29_Template(rf, ctx) { if (rf & 1) {
    ...
    const object_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function BookingProductPage_ion_item_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_ion_item_9_Template_button_click_42_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const object_r8 = ctx.$implicit; const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.downNumberProduct(object_r8._id); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_ion_item_9_Template_button_click_46_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const object_r8 = ctx.$implicit; const ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r13.upNumberProduct(object_r8._id); });
...
function BookingProductPage_img_21_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 66);
} }
function BookingProductPage_img_28_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 66);
} }
function BookingProductPage_label_37_Template(rf, ctx) { if (rf & 1) {
...
function BookingProductPage_ion_select_option_41_Template(rf, ctx) { if (rf & 1) {
...
function BookingProductPage_label_46_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "label", 67);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](2, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function BookingProductPage_div_54_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 69);
} }
function BookingProductPage_div_55_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_div_55_Template_ion_item_click_11_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r15.eventButtonClosePopup(); });
...
const _c2 = function () { return { "color": "#ffffff" }; };
class BookingProductPage {
    constructor(modalController, loading, navCtrl, apiService, datePipe, route, location) {
    ...
    eventButtonSend() {
        ...
        this.apiService.postRequestionOrderProduct(this.orderInfor, this.paymentMode.toString(), this.form_apartment_id, this.form_start_time, this.form_phone_number, this.form_note, requestShopProduct, dataApartment.campaign.title + " ," + dataApartment.campaign.address, dataApartment.campaign.latlng).subscribe(result => {
            self.loading.dismiss();
...
BookingProductPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BookingProductPage, selectors: [["app-booking-product"]], decls: 60, vars: 56, consts: [[1, "ion-no-border"], [1, "groupon-ion-toolbar"], ["slot", "start"], ["text", "", "icon", "chevron-back", 3, "ngStyle"], ["lines", "full", 1, "ion-no-margin", "ion-no-padding"], ["lines", "none", "class", "margin-top-10", 4, "ngFor", "ngForOf"], ["lines", "none", 1, "margin-top-20", "line-1"], [1, "font-weight-bold", "margin-left-20", "margin-top-20", "margin-bottom-5"], ["lines", "none", 1, "margin-top-20"], ["lines", "none", 1, "item-common", "no-border", "margin-right-5", 3, "click"], ["src", "../assets/icon/svg/money-1.svg", 1, "image-button-payment"], [1, "button-1-text", "padding-right-10"], ["class", "button-1-icon", "src", "../assets/icon/svg/Fill.svg", 4, "ngIf"], ["lines", "none", 1, "item-common", "no-border", "margin-left-5", 3, "click"], ["src", "../assets/icon/svg/money-2.svg", 1, "image-button-payment"], ["lines", "none", 1, "item-common"], ["src", "../assets/icon/svg/my-home.svg", 1, "icon-home"], ["src", "../assets/icon/svg/Down.svg", 1, "icon-pulldown-down"], ["class", "pulldown-1-placeholder", 4, "ngIf"], ["interface", "action-sheet", "name", "form_apartment_id", 1, "pulldown-apartment-select", 3, "placeholder", "ngModel", "ngModelChange", "ionChange"], [3, "value", 4, "ngFor", "ngForOf"], ["src", "../assets/icon/svg/Clock.svg", 1, "icon-home"], ["name", "form_start_time", "displayFormat", "DD/MM/YYYY HH:mm", "min", "2000", "max", "2050", 1, "datetime-commom", 3, "placeholder", "ngModel", "ngModelChange", "ionChange"], ["lines", "none", 1, "margin-top-20", "margin-bottom-30"], ["rows", "4", "cols", "20", 1, "text-area-1", 3, "placeholder", "ngModel", "ngModelChange"], ["class", "modal-backdrop fade show", 4, "ngIf"], ["class", "modal", "tabindex", "-1", "role", "dialog", 4, "ngIf"], [1, "full-width", "function-section", "shadow-section"], ["expand", "block", 3, "click"], ["lines", "none", 1, "margin-top-10"], [1, "col-12"], [1, "div-promotion-code"], [1, "ion-grid-class", "ion-no-padding"], [1, ""], ["size", "12", 1, "ion-col-class"], [1, "promotion-code-2"], [1, "padding-top-10", "padding-bottom-10"], [1, "col-12", "promotion-code-3"], ["src", "../assets/icon/svg/people_black.svg", "alt", "", 1, "item-1"], [1, "item-2"], [1, "range-1", 3, "ngStyle"], [1, "range-2"], [1, "row", "col-12"], [1, "promotion-code-4"], [1, "promotion-code-5", 3, "ngStyle"], [1, "promotion-code-6"], [1, "ion-grid-class", "ion-no-padding", "pading-ion-grid", "margin-top-15"], [1, "row-data-product", 3, "id"], ["size", "3", 1, "ion-col-class"], [1, "div-logo"], [3, "src"], ["class", "note-2", 4, "ngIf"], ["size", "9", 1, "item", "ion-col-class", "group-2-col-2"], [1, "row", "div-title-col-2"], [1, "col-8"], [1, "font-weight-bold", "white-space-normal"], [1, "col-4"], [1, "div-note-col-2"], [1, "white-space-normal"], [1, "group-1-button-change-number"], [1, "button-3-1", 3, "click"], ["src", "../assets/icon/svg/tru.svg", 1, "icon-button-3"], [1, "group-1-label-1", "font-weight-bold"], [1, "button-3-2", 3, "click"], ["src", "../assets/icon/svg/plus.svg", 1, "icon-button-3"], [1, "note-2"], ["src", "../assets/icon/svg/Fill.svg", 1, "button-1-icon"], [1, "pulldown-1-placeholder"], [3, "value"], [1, "modal-backdrop", "fade", "show"], ["tabindex", "-1", "role", "dialog", 1, "modal"], ["role", "document", 1, "modal-dialog"], [1, "modal-content"], [1, "modal-body", "padding-top-30", "margin-top-30"], ["lines", "full", 1, "ion-no-margin", "ion-no-padding", "margin-top-10"], ["lines", "none", "id", "area-show-image", 1, "popup-ion-item"], ["src", "../assets/icon/svg/Outline.svg", 1, ""], [1, "popup-text-1"], ["lines", "none", "id", "area-show-image", 1, "popup-ion-item", 3, "click"], [1, "popup-text-2"]], template: function BookingProductPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_Template_ion_item_click_15_listener() { return ctx.eventButton1(0); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_Template_ion_item_click_22_listener() { return ctx.eventButton1(1); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BookingProductPage_Template_ion_select_ngModelChange_39_listener($event) { return ctx.form_apartment_id = $event; })("ionChange", function BookingProductPage_Template_ion_select_ionChange_39_listener($event) { return ctx.ionChangePulldown1($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BookingProductPage_Template_ion_datetime_ngModelChange_48_listener($event) { return ctx.form_start_time = $event; })("ionChange", function BookingProductPage_Template_ion_datetime_ionChange_48_listener() { return ctx.ionChangeStartTime(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BookingProductPage_Template_ion_textarea_ngModelChange_52_listener($event) { return ctx.form_note = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BookingProductPage_Template_ion_button_click_57_listener() { return ctx.eventButtonSend(); });
...
//# sourceMappingURL=pages-booking-product-booking-product-module-es2015.js.map