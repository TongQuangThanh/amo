...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopupChangeLanguagePage", function() { return PopupChangeLanguagePage; });
...
PopupChangeLanguagePage.ɵfac = function PopupChangeLanguagePage_Factory(t) { return new (t || PopupChangeLanguagePage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"])); };
PopupChangeLanguagePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PopupChangeLanguagePage, selectors: [["app-popup-change-language"]], decls: 20, vars: 13, consts: [[1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item", "ion-no-padding"], [1, "popup-title"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], ["lines", "none", 3, "ngClass", "click"], [1, "select-title"], ["slot", "end", 1, "btn-done"], ["name", "checkmark-circle", 3, "ngClass"]], template: function PopupChangeLanguagePage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupChangeLanguagePage_Template_ion_buttons_click_6_listener() { return ctx.closeModal(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupChangeLanguagePage_Template_ion_item_click_8_listener() { return ctx.languageChanged("vi"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupChangeLanguagePage_Template_ion_item_click_14_listener() { return ctx.languageChanged("en"); });
...
//# sourceMappingURL=default~pages-my-account-my-account-module~pages-popup-change-language-popup-change-language-module-es2015.js.map