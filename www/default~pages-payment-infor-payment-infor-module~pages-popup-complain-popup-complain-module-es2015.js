...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopupComplainPage", function() { return PopupComplainPage; });
...
/* harmony import */ var src_app_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/services/auth/auth.service */ "9ans");
...
const _c0 = ["content"];
const _c1 = ["chat_input"];
function PopupComplainPage_ion_item_11_div_1_Template(rf, ctx) { if (rf & 1) {
...
function PopupComplainPage_ion_item_11_div_2_Template(rf, ctx) { if (rf & 1) {
...
function PopupComplainPage_ion_item_11_div_3_Template(rf, ctx) { if (rf & 1) {
...
function PopupComplainPage_ion_item_11_div_4_Template(rf, ctx) { if (rf & 1) {
...
function PopupComplainPage_ion_item_11_div_5_Template(rf, ctx) { if (rf & 1) {
...
function PopupComplainPage_ion_item_11_Template(rf, ctx) { if (rf & 1) {
...
class PopupComplainPage {
    constructor(translateConfigService, modalController, platform, loading, apiService, navCtrl, navParams, authService, camera, actionSheetController, alertService, translate, route) {
    ...
    sendMsg() {
        ...
        this.apiService.sendPaymentComment(params)
            .subscribe(result => {
            self.data_chat.push({ type: 'right', avatar: "", message: self.editorMsg });
            self.loading.dismiss();
            self.editorMsg = "";
            self.scrollToBottom();
        }, error => {
...
PopupComplainPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: PopupComplainPage, selectors: [["app-popup-complain"]], viewQuery: function PopupComplainPage_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 20, vars: 8, consts: [["no-bounce", "", 1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item", "ion-no-padding"], [1, "popup-title"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], [1, "list-chat-content"], ["content", ""], ["lines", "full", 1, "ion-no-margin", "ion-no-padding", "padding-top-10", "padding-bottom-20", "ion-list-class"], [3, "class", 4, "ngFor", "ngForOf"], [1, "ion-no-border", "footer-content"], ["lines", "none", 1, "add-comment-item"], [1, "div-select-image", 3, "click"], ["name", "image", "slot", "start", 1, "add-image-icon"], ["rows", "1", "wrap", "soft", "maxlength", "500", "auto-grow", "", 1, "input-area", 3, "ngModel", "placeholder", "ngModelChange"], ["chat_input", ""], ["name", "paper-plane", 1, "icon-send", "icon-send-default", 3, "click"], ["class", "div-avatar", 4, "ngIf"], ["class", "col-7", 4, "ngIf"], ["class", "col-7 div-image-message-left", 4, "ngIf"], ["class", "col-7 div-label-message-right", "slot", "end", 4, "ngIf"], ["class", "col-7 div-image-message-right", "slot", "end", 4, "ngIf"], [1, "div-avatar"], [3, "src"], [1, "col-7"], [1, "label-message-left-bql"], [1, "div-label-message-left"], [1, "label-message-left"], [1, "col-7", "div-image-message-left"], [1, "", 3, "src"], ["slot", "end", 1, "col-7", "div-label-message-right"], [1, "label-message-right"], ["slot", "end", 1, "col-7", "div-image-message-right"]], template: function PopupComplainPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PopupComplainPage_Template_ion_buttons_click_6_listener() { return ctx.closeModal(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PopupComplainPage_Template_div_click_14_listener() { return ctx.selectImage(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngModelChange", function PopupComplainPage_Template_ion_textarea_ngModelChange_16_listener($event) { return ctx.editorMsg = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipe"](18, "translate");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](19, "ion-icon", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PopupComplainPage_Template_ion_icon_click_19_listener() { return ctx.sendMsg(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](PopupComplainPage, [{
    ...
    }], function () { return [{ type: _translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"] }, { type: _services_loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"] }, { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavParams"] }, { type: src_app_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"] }, { type: _ionic_native_Camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ActionSheetController"] }, { type: _services_alert_alert_service__WEBPACK_IMPORTED_MODULE_8__["AlertService"] }, { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }]; }, { content: [{
...
//# sourceMappingURL=default~pages-payment-infor-payment-infor-module~pages-popup-complain-popup-complain-module-es2015.js.map