...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopupFeedbackPage", function() { return PopupFeedbackPage; });
...
function PopupFeedbackPage_ion_button_12_Template(rf, ctx) { if (rf & 1) {
...
function PopupFeedbackPage_ion_button_13_Template(rf, ctx) { if (rf & 1) {
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-button", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupFeedbackPage_ion_button_13_Template_ion_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.sendFeedback(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ion-label", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](3, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class PopupFeedbackPage {
    constructor(translateConfigService, modalController, translate, navCtrl, apiService, loading, alertService, authService) {
...
PopupFeedbackPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PopupFeedbackPage, selectors: [["app-popup-feedback"]], decls: 14, vars: 9, consts: [[1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item", "ion-no-padding"], [1, "popup-title"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], ["lines", "none", 1, "modal-item", "feedback-textarea"], ["rows", "5", 1, "feedback-textarea-placeholder", 3, "placeholder", "ngModel", "ngModelChange"], ["lines", "none", 1, "ion-text-center", "modal-toolbar"], ["class", "delete-button", 4, "ngIf"], ["class", "delete-button", 3, "click", 4, "ngIf"], [1, "delete-button"], [1, "delete-button-label"], [1, "delete-button", 3, "click"]], template: function PopupFeedbackPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupFeedbackPage_Template_ion_buttons_click_6_listener() { return ctx.closeModal(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PopupFeedbackPage_Template_ion_textarea_ngModelChange_9_listener($event) { return ctx.message = $event; });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupFeedbackPage, [{
    ...
    }], function () { return [{ type: _translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"] }, { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"] }, { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }, { type: _services_loading_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"] }, { type: _services_alert_alert_service__WEBPACK_IMPORTED_MODULE_6__["AlertService"] }, { type: src_app_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~pages-my-account-my-account-module~pages-popup-feedback-popup-feedback-module-es2015.js.map