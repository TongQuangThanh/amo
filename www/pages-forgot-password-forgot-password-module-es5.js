(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-forgot-password-forgot-password-module"], {
    ...
    function cZHL(module, __webpack_exports__, __webpack_require__) {
      ...
      var _utils_const_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../../utils/const.service */
      "KQOL");
      /* harmony import */
      ...
      var _popup_pincode_password_popup_pincode_password_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../popup-pincode-password/popup-pincode-password.page */
      "JbAG");
      /* harmony import */
      ...
      var ForgotPasswordPage = /*#__PURE__*/function () {
        function ForgotPasswordPage(loading, modalController, navCtrl, alertService, translate, apiService) {
        ...
        _createClass(ForgotPasswordPage, [{
          ...
          value: function sendSMS() {
            ...
            this.apiService.forgotPassword(this.phoneNumber).subscribe(function (result) {
              self.loading.dismiss();
              self.presentModal();
            }, function (error) {
              self.loading.dismiss();
              self.alertService.presentToast(_this.translate.instant('FORGOT_PASSWORD.error_message'));
            });
          }
        }, {
          key: "presentModal",
                      ...
                      modal.onDidDismiss().then(function (dataReturned) {
                        if (dataReturned !== null) {
                          ...
                          if (dataReturnedResult.result == '0') {
                            _this2.navCtrl.navigateRoot('/new-password/' + _this2.phoneNumber + "/" + dataReturnedResult.token);
                          } else {}
                        }
                      });
                      _context.next = 6;
      ...
      ForgotPasswordPage.ɵfac = function ForgotPasswordPage_Factory(t) {
        return new (t || ForgotPasswordPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_alert_alert_service__WEBPACK_IMPORTED_MODULE_7__["AlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]));
      };
      ...
      ForgotPasswordPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 24,
        vars: 15,
        consts: [[1, "ion-no-border"], [1, "login-header"], ["color", "light", "text", "", "icon", "chevron-back"], [1, "login-title"], ["lines", "none", 1, "margin-top-10"], [1, "ion-text-wrap", "note-text"], [1, "forgot-password-input"], ["lines", "none", 1, "input-item"], ["name", "custom-mobile", "src", "../assets/icon/svg/profile.svg", "slot", "start", 1, "input-icon"], ["position", "floating", 1, "input-floating-label"], ["type", "phone", 1, "input-text", 3, "ngModel", "ngModelChange"], ["expand", "block", 1, "", 3, "ngClass", "disabled", "click"], [1, "button-next-label"]],
        template: function ForgotPasswordPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function ForgotPasswordPage_Template_ion_input_ngModelChange_19_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ForgotPasswordPage_Template_ion_button_click_20_listener() {
              return ctx.sendSMS();
            });
