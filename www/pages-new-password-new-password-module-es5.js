(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-new-password-new-password-module"], {
    ...
    /***/
    function J6Q5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function NewPasswordPage_ion_item_31_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var NewPasswordPage = /*#__PURE__*/function () {
        function NewPasswordPage(translate, alertService, loading, apiService, navCtrl, route) {
        ...
        _createClass(NewPasswordPage, [{
          ...
          key: "togglePasswordNew",
          value: function togglePasswordNew() {
            //this.showPassword != this.showPassword;
          ...
          value: function checkNewPassword() {
          ...
          value: function updateAccount() {
            ...
            this.apiService.resetPassword(params).subscribe(function (result) {
              self.loading.dismiss();
              self.errorMessage = "";
              self.errorNewPass = false;
              self.errorConfirmPass = false;
              self.alertService.presentToast(_this.translate.instant('NEW_PASSWORD.message_change_pass_sucess'));
      ...
      NewPasswordPage.ɵfac = function NewPasswordPage_Factory(t) {
        return new (t || NewPasswordPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_alert_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]));
      };

      NewPasswordPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: NewPasswordPage,
        selectors: [["app-new-password"]],
        decls: 36,
        vars: 26,
        consts: [[1, "ion-no-border"], [1, "login-header"], ["color", "light", "text", "", "icon", "chevron-back"], [1, "login-title"], ["lines", "none", 1, "form-class", "note-style"], [1, "ion-text-wrap", "label-text"], [1, "change-password-input"], ["lines", "none", 1, "input-item"], ["name", "custom-locker", "src", "/assets/icon/custom-locker.svg", "slot", "start", 1, "input-icon"], ["position", "floating", 1, "input-floating-label"], ["name", "newPassword", 1, "input-text", 3, "ngModel", "type", "ngModelChange"], ["name", "checkmark-circle", "slot", "end", 3, "ngClass"], ["slot", "end", 1, "pass-hide-icon", 3, "name", "click"], ["name", "confirmPassword", 1, "input-text", 3, "ngModel", "type", "ngModelChange"], ["lines", "none", "class", "margin-top-10", 4, "ngIf"], ["expand", "block", 1, "", 3, "ngClass", "disabled", "click"], [1, "button-change-pass-label"], ["lines", "none", 1, "margin-top-10"], ["color", "danger", 1, "error-message"]],
        template: function NewPasswordPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function NewPasswordPage_Template_ion_input_ngModelChange_20_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewPasswordPage_Template_ion_icon_click_22_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function NewPasswordPage_Template_ion_input_ngModelChange_28_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewPasswordPage_Template_ion_icon_click_30_listener() {
              return ctx.togglePasswordNew();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewPasswordPage_Template_ion_button_click_32_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewPasswordPage, [{
    ...
    /***/
    function UHzO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _new_password_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./new-password.page */
      "J6Q5");
      /* harmony import */
      ...
      NewPasswordPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NewPasswordPageModule
      });
      NewPasswordPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function NewPasswordPageModule_Factory(t) {
          return new (t || NewPasswordPageModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewPasswordPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewPasswordPageModule, [{
...
//# sourceMappingURL=pages-new-password-new-password-module-es5.js.map