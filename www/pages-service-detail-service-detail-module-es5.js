(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-service-detail-service-detail-module"], {
    ...
    /***/
    function IkRN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServiceDetailPageModule", function () {
      ...
      var _service_detail_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./service-detail.page */
      "zh7t");
      /* harmony import */
      ...
      var ServiceDetailPageModule = function ServiceDetailPageModule() {
        _classCallCheck(this, ServiceDetailPageModule);
      };

      ServiceDetailPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ServiceDetailPageModule
      });
      ServiceDetailPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ServiceDetailPageModule_Factory(t) {
          return new (t || ServiceDetailPageModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ServiceDetailPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceDetailPageModule, [{
    ...
    /***/
    function zh7t(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServiceDetailPage", function () {
      ...
      var ServiceDetailPage = /*#__PURE__*/function () {
        function ServiceDetailPage(loading, apiService, navCtrl, route) {
          _classCallCheck(this, ServiceDetailPage);
        ...
        _createClass(ServiceDetailPage, [{
          key: "ngOnInit",
          ...
          key: "getNewDetail",
          value: function getNewDetail(serviceID) {
            var self = this;
            this.loading.present();
            this.apiService.getServiceDetail(serviceID).subscribe(function (result) {
      ...
      ServiceDetailPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ServiceDetailPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ServiceDetailPage_Template_ion_button_click_25_listener($event) {
              return ctx.orderService($event);
            });
...
//# sourceMappingURL=pages-service-detail-service-detail-module-es5.js.map