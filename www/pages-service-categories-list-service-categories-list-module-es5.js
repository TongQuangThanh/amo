(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-service-categories-list-service-categories-list-module"], {
    ...
    /***/
    function QiG7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServiceCategoriesListPage", function () {
        return ServiceCategoriesListPage;
      });
      /* harmony import */
      ...
      var _utils_const_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../utils/const.service */
      "KQOL");
      /* harmony import */
      ...
      function ServiceCategoriesListPage_ion_col_12_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ServiceCategoriesListPage_ion_col_12_Template_div_click_1_listener() {
            ...
            return ctx_r2.redirectToCategory(item_r1.category._id, item_r1.category.title, item_r1._id);
          });
      ...
      var ServiceCategoriesListPage = /*#__PURE__*/function () {
        function ServiceCategoriesListPage(modalController, camera, actionSheetController, loading, navCtrl, apiService, route) {
          _classCallCheck(this, ServiceCategoriesListPage);
        ...
        _createClass(ServiceCategoriesListPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.data_shop_house = {};
            var category_id = this.route.snapshot.paramMap.get('categoryId');
            var category_name = this.route.snapshot.paramMap.get('categoryName');
          ...
          value: function getListCategories(categoryGroupId) {
            ...
            this.apiService.getListSubCateV2(categoryGroupId).subscribe(function (res) {
              ...
              console.warn(_this.listCategories);

              _this.loading.dismiss();
            });
          }
        }, {
          key: "redirectToCategory",
          value: function redirectToCategory(id, name, choosenCate) {
      ...
      ServiceCategoriesListPage.ɵfac = function ServiceCategoriesListPage_Factory(t) {
        return new (t || ServiceCategoriesListPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_native_Camera_ngx__WEBPACK_IMPORTED_MODULE_1__["Camera"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ActionSheetController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]));
      };

      ServiceCategoriesListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: ServiceCategoriesListPage,
        selectors: [["app-service-categories-list"]],
        decls: 13,
        vars: 5,
        consts: [[1, "cate-service-header"], [1, "back-button"], ["color", "light", "text", "", "icon", "chevron-back", 1, "ion-back-button"], [1, "header-title"], [1, "header-sub-title"], [1, "screen-content"], [1, "list-view-custom"], [1, "ion-grid-class"], ["class", "ion-col-class", "size", "6", 4, "ngFor", "ngForOf"], ["size", "6", 1, "ion-col-class"], [1, "div-button-1", 3, "click"], [1, "div-1"], [1, "class-image-button", 3, "src"], [1, "div-2"], ["lines", "none"], [1, "cate-title"]],
        template: function ServiceCategoriesListPage_Template(rf, ctx) {
          if (rf & 1) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceCategoriesListPage, [{
    ...
    function o8v(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ServiceCategoriesListPageModule", function () {
        return ServiceCategoriesListPageModule;
      });
      /* harmony import */
      ...
      var _service_categories_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./service-categories-list.page */
      "QiG7");
      ...
      var ServiceCategoriesListPageModule = function ServiceCategoriesListPageModule() {
        _classCallCheck(this, ServiceCategoriesListPageModule);
      };

      ServiceCategoriesListPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ServiceCategoriesListPageModule
      });
      ServiceCategoriesListPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ServiceCategoriesListPageModule_Factory(t) {
          return new (t || ServiceCategoriesListPageModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"], _ionic_super_tabs_angular__WEBPACK_IMPORTED_MODULE_6__["SuperTabsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ServiceCategoriesListPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceCategoriesListPageModule, [{
...
//# sourceMappingURL=pages-service-categories-list-service-categories-list-module-es5.js.map