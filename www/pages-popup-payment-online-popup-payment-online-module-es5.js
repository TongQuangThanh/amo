(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-popup-payment-online-popup-payment-online-module"], {
    ...
    /***/
    function DUk0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupPaymentOnlinePageModule", function () {
        return PopupPaymentOnlinePageModule;
      });
      /* harmony import */
      ...
      var _popup_payment_online_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./popup-payment-online-routing.module */
      "yHBk");
      /* harmony import */


      var _popup_payment_online_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./popup-payment-online.page */
      "SdbJ");

      var PopupPaymentOnlinePageModule = function PopupPaymentOnlinePageModule() {
        _classCallCheck(this, PopupPaymentOnlinePageModule);
      };

      PopupPaymentOnlinePageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: PopupPaymentOnlinePageModule
      });
      PopupPaymentOnlinePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function PopupPaymentOnlinePageModule_Factory(t) {
          return new (t || PopupPaymentOnlinePageModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"], _popup_payment_online_routing_module__WEBPACK_IMPORTED_MODULE_5__["PopupPaymentOnlinePageRoutingModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PopupPaymentOnlinePageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupPaymentOnlinePageModule, [{
    ...
    /***/
    function SdbJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupPaymentOnlinePage", function () {
        return PopupPaymentOnlinePage;
      });
      /* harmony import */
      ...
      var PopupPaymentOnlinePage = /*#__PURE__*/function () {
        function PopupPaymentOnlinePage(translateConfigService, modalController) {
          _classCallCheck(this, PopupPaymentOnlinePage);
        ...
        _createClass(PopupPaymentOnlinePage, [{
          key: "ngOnInit",
      ...
      PopupPaymentOnlinePage.ɵfac = function PopupPaymentOnlinePage_Factory(t) {
        return new (t || PopupPaymentOnlinePage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_translate_config_service__WEBPACK_IMPORTED_MODULE_2__["TranslateConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]));
      };

      PopupPaymentOnlinePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: PopupPaymentOnlinePage,
        selectors: [["app-popup-payment-online"]],
        decls: 34,
        vars: 6,
        consts: [[1, "content-wrap"], [1, "content-container"], ["lines", "none", 1, "header-item", "ion-no-padding"], [1, "popup-title"], ["slot", "end", 1, "btn-close-popup", 3, "click"], ["name", "close"], ["lines", "none", 1, "select-item", "ion-no-padding", "btn-language-active"], [1, "select-title"], ["src", "assets/icon/logo_VNPay.png"], ["slot", "end", 1, "btn-done"], ["name", "checkmark-circle", 1, "active"], ["lines", "none", 1, "select-item", "ion-no-padding"], ["src", "assets/icon/logo_Momo.png"], ["name", "checkmark-circle", 1, "hide"], ["src", "assets/icon/logo_AirPay.png"], ["src", "assets/icon/logo_ZaloPay.png"], ["lines", "none", 1, "select-item", "ion-no-padding", "no-padding-end"], [1, "select-title", "ion-no-padding"], [1, "add-button"], [1, "add-button-label"]],
        template: function PopupPaymentOnlinePage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PopupPaymentOnlinePage_Template_ion_buttons_click_6_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupPaymentOnlinePage, [{
    ...
    /***/
    function yHBk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopupPaymentOnlinePageRoutingModule", function () {
        return PopupPaymentOnlinePageRoutingModule;
      });
      /* harmony import */
      ...
      var _popup_payment_online_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./popup-payment-online.page */
      "SdbJ");
      ...
      var PopupPaymentOnlinePageRoutingModule = function PopupPaymentOnlinePageRoutingModule() {
        _classCallCheck(this, PopupPaymentOnlinePageRoutingModule);
      };

      PopupPaymentOnlinePageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: PopupPaymentOnlinePageRoutingModule
      });
      PopupPaymentOnlinePageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function PopupPaymentOnlinePageRoutingModule_Factory(t) {
          return new (t || PopupPaymentOnlinePageRoutingModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PopupPaymentOnlinePageRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopupPaymentOnlinePageRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
...
//# sourceMappingURL=pages-popup-payment-online-popup-payment-online-module-es5.js.map