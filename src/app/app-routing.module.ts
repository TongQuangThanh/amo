...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/popup-booking-service/popup-booking-service.module').then(m => m.PopupBookingServiceModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/delete-home-member/delete-home-member.module').then(m => m.DeleteHomeMemberPageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/popup-payment-function/popup-payment-function.module').then(m => m.PopupPaymentFunctionPageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/popup-share-info/popup-share-info.module').then(m => m.PopupShareInfoModule)
  },
  {
    path: 'register-wallet',
    loadChildren: () => import('./pages/wallet/register-wallet/register-wallet.module').then(m => m.RegisterWalletModule)
  },
  {
  ...
  {
    path: 'payment-fail',
    loadChildren: () => import('./pages/payment-fail/payment-fail.module').then(m => m.PaymentFailPageModule)
  },
  {
    path: 'survey/:id',
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/popup-shop-order-result/popup-shop-order-result.module').then(m => m.PopupShopOrderResultModule)
  },
  {
    path: 'order-service-success',
    loadChildren: () => import('./pages/order-service-success/order-service-success.module').then(m => m.OrderServiceSuccessPageModule)
  },
  {
    path: 'popup-rating-shop',
    loadChildren: () => import('./pages/popup-rating-shop/popup-rating-shop.module').then(m => m.PopupRatingShopPageModule)
  },
  {
    path: 'popup-change-time-order',
    loadChildren: () => import('./pages/popup-change-time-order/popup-change-time-order.module').then(m => m.PopupChangeTimeOrderPageModule)
  },
  {
    path: 'popup-survey-detail',
    loadChildren: () => import('./pages/popup-survey-detail/popup-survey-detail.module').then(m => m.PopupSurveyDetailPageModule)
  },
  {
    path: 'survey-post-complete',
    loadChildren: () => import('./pages/survey-complete/survey-complete.module').then(m => m.SurveyCompletePageModule)
  },
];
